...
async function _getProductCategories(): Promise<string[]> {
...
export const getProductCategories = cache(_getProductCategories);

async function _getProducts(): Promise<ProductDef[]> {
    // const response = await axiosInstance.get("products/categories")
    // const response = await axiosInstance.get("products")
    // return response.data;
